    ...
    <nav class="bg-opacity-0 border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
            ...
            <div v-if="!token" class="items-center" >
                <router-link to="/mypage" class="flex text-sm text-white font-medium dark:text-blue-500 hover:underline">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-1 w-6 h-6 text-white-600">
