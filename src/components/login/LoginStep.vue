    ...
    <div class="card card-one glass">
      ...
      <div class="bg-light-blue">
        ...
        <div v-if="!hasBrowserExtension" class="desc">
          <p class="p-1">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                class="w-5 h-5 text-blue-800 inline"
              >
                <path
                  fill-rule="evenodd"
          ...
          <div class="text-center inline-block"></div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getChainId() {
      return this.$store.dispatch("userStore/getChainID").then(() => {});
    },
    getHasBrowserExtension() {
      return this.$store.dispatch("userStore/getHasBrowserExtension");
    },
    registerUser() {
    ...
    getDetail() {
      ...
      return this.$store.dispatch("userStore/getDetail", token).then(() => {});
    },
  },
};
</script>
