  ...
  actions: {
    ...
    getVoteDetail(state, commit) {
      ...
      const termRequestUri =
          process.env.VUE_APP_API_ENDPOINT +'dataset/'+ commit + '/vote';
      return client
          .get(
          termRequestUri,
          {
    ...
    getVoteStatus(state, commit) {
        const client = applyCaseMiddleware(axios.create());
        const termRequestUri =
            process.env.VUE_APP_API_ENDPOINT +'dataset/'+ commit + '/vote_status';
        return client
            .get(
            termRequestUri,
            {
    ...
    vote(state, commit) {
      const client = applyCaseMiddleware(axios.create());
      const termRequestUri =
          process.env.VUE_APP_API_ENDPOINT +'dataset/'+ commit.datasetId + '/vote';
